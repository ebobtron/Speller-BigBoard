...
<div class="gentext">
  ...
  <h2> file submission continued </h2>
    ...
    group: <? echo $title; ?><br />
    submitters name: <? echo $name; ?><br />
    submitters email: <? echo $_POST['email']; ?><br />
<br />
<br />
...
<?php
    echo "
        <form enctype='multipart/form-data' action='uploadfile.php' method='POST'>
            ...
            Please send <h3> \"speller\"</h3> not speller.c, thank you.<br /><br />
            Select File to Upload: <input type='file' name='uploadedfile'><br />
            <br />
